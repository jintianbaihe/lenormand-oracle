        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            <div className="aspect-[2/3] w-full glass-morphism rounded-xl flex flex-col items-center justify-between py-3 card-inner-glow relative overflow-hidden group border border-slate-200 dark:border-white/5 dark:bg-slate-900/40">
              ...
              <span className="text-[9px] font-bold opacity-30 z-10 text-slate-500 dark:text-slate-100">{card.id.toString().padStart(2, '0')}</span>
              <div className="text-indigo-600 dark:text-indigo-300 z-10">
                {React.createElement(IconMap[card.icon] || Sparkles, { size: 28, strokeWidth: 1.5 })}
              </div>
              <span className="text-[7px] uppercase tracking-widest opacity-60 font-bold text-center px-1 z-10 leading-tight text-slate-500 dark:text-slate-100">
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center">
            ...
            >
              ...
              <div className="flex justify-center gap-3 mb-10">
                {cards.map((card) => (
                  <div key={card.id} className="w-20 aspect-[2/3] glass-morphism rounded-xl flex flex-col items-center justify-center gap-2 border-slate-200 dark:border-primary/20 dark:bg-slate-900/40 dark:shadow-[0_0_12px_rgba(99,102,241,0.3)]">
